                        ...
                        <div class="userinfo_edit">
                            ...
                            <form action="" method="post" class="layui-form">
                                ...
                                <div class="username input_box">
                                    <input type="text" id="userinfoEditUserName" value="<?php echo ($user_info["user_name"]); ?>" name="user_name" placeholder="请输入常用昵称" maxlength="15"
                                        data-maxlength="15">
                                    <input type="text" id="userinfoEditUserName" value="<?php echo ($user_info["user_age"]); ?>" name="user_age" placeholder="请输入年龄" maxlength="15"
                                        data-maxlength="15">
                                    ...
                                    <input type="text" id="userinfoEditUserName" name="user_address" placeholder="请输入地址" value="<?php echo ($user_info["user_address"]); ?>" maxlength="15"
                                        data-maxlength="15">
