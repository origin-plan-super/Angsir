                        ...
                        <div class="userinfo_edit">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="username input_box">
                                    <input type="text" id="userinfoEditUserName" name="user_name" placeholder="请输入常用昵称" maxlength="15" data-maxlength="15">
                                    <input type="text" id="userinfoEditUserName" name="user_age" placeholder="请输入年龄" maxlength="15" data-maxlength="15">
                                    ...
                                    <div class="select_pop js_popindustry" maxselectcount="3" style="width:400px; margin:10px 0" selecttxt="行业">
                                        ...
                                        <input class="form-control control-sm js_pop_text" placeholder="请选择行业" name="industry[text]" type="text" value="计算机软件,通信/电信/网络设备,网络游戏" readonly=""
                                    ...
                                    <input type="text" id="userinfoEditUserName" name="user_address" placeholder="请输入地址" maxlength="15" data-maxlength="15">
                                    <!-- <input type="text" id="userinfoEditUserName" name="" placeholder="请输入邮箱" maxlength="15" data-maxlength="15"> -->
                                </div>

                                <div class="toolbar">
                                    <!-- <a class="btn userinfo_save" href="javascript:;" data-lg-tj-id="18k0" data-lg-tj-no="idnull" data-lg-tj-cid="idnull">保存</a> -->
                                    <input class="btn userinfo_save" value="保存" type='submit'></input>
                                </div>
                            </form>
