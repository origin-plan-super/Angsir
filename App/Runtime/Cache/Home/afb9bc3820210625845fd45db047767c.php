                    ...
                    <div class="c_section">
                        <div class="userinfo_edit" id="userinfoEdit">
                            <div class="hadInfo">
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo U('Article/article');?>">销售工程师</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo U('Article/article');?>">软件工程师</a>
                                    </li>
    ...
    <div class="side-bar1">
        ...
        <a href="javascript:;">
            ...
            <div class="sb-hover">
                ...
                <p class="qr-box">
                    <img src="image/bl_weixin.jpg" alt="" class="js_bl_qr_weixin" data-bd-imgshare-binded="1"> </p>
